...
class NotificationWidget : public QWidget
{
    Q_OBJECT
public:
    NotificationWidget(const QString &message, QWidget *parent = nullptr) : QWidget(parent)
    {
        ...
        // closeButton->setStyleSheet("QPushButton { background: transparent; color: white; border: none; font-weight:
        // bold; }"
